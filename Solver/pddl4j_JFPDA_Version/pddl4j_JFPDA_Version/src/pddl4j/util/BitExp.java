...
/**
 * This class implements an bit set expression. A bit set expression is used to
 * encode preconditions (negative and positive) but also effects of the
...
public class BitExp implements Serializable {
	 ...
	 */
	private final BitVector	positive;

	/**
	 * The bit set used to store the negative facts of the expression.
	 */
	private final BitVector	negative;

	/**
	 * Creates a new bit set expression. By default the expression has no positive
	 * and no negative fact.
	 */
	public BitExp() {
	...
	/**
	 * Creates a new bit expression from a specified positive and negative bit set
	 * that represent respectively the positive and the negative fact of the
	 * expression.
	 * 
	 * @param positive the bit set that represents the positive facts of the
	 *          expression.
	 * @param negative the bit set that represents the negative facts of the
	 *          expression.
	 * @throws NullPointerException if
	 *           <code>positive == null || negative == null</code>.
	 */
	...
	/**
	 * Returns if the expression is empty, i.e., the expression has no positive
	 * and no negative facts. Such an expression is always true.
	 * 
	 * @return <code>true</code> if the expression is empty; <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Returns the cardinality of the bit expression, i.e., the number of
	 * propositions contained in the expression.
	 * 
	...
	/**
	 * Return if a specified object is equals to this expression. The specified
	 * object is equal to the expression if and only if the object is an instance
	 * of the class <code>BitExp</code> and it has the same positive and negative
	 * facts.
	 * 
	 * @param obj the specified object to compared.
	 * @return <code>true</code> if the specified object is equal to the
