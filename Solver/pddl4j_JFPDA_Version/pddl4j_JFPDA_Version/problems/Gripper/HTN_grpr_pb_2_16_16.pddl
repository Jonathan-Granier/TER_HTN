...
(:goal
       :tasks(
				...
				(tag t11 (transport ball11 A B))
				(tag t12 (transport ball12 A B))
				(tag t13 (transport ball13 A B))
				(tag t14 (transport ball14 A B))
				(tag t15 (transport ball15 A B))
				(tag t16 (transport ball16 A B))
       	     )
       :constraints (and 
       					(after (and (at ball1 B)(at ball2 B)(at ball3 B)(at ball4 B)
       							...
       							) last(t1 t2 t3 t4 t5 t6 t7 t8 t9 t10 t11 t12 t13 t14 t15 t16)
       					)
					)
)
