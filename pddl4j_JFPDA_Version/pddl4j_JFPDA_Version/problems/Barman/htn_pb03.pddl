...
(:goal
    :tasks  (
                (tag t1 (do_cocktail_in_shot shot1 cocktail7))
                (tag t2 (do_cocktail_in_shot shot2 cocktail5))
                (tag t3 (do_cocktail_in_shot shot3 cocktail8))
                (tag t4 (do_cocktail_in_shot shot4 cocktail1))
                (tag t5 (do_cocktail_in_shot shot5 cocktail9))
                (tag t6 (do_cocktail_in_shot shot6 cocktail3))
                (tag t7 (do_cocktail_in_shot shot7 cocktail11))
                (tag t8 (do_cocktail_in_shot shot8 cocktail10))
                (tag t9 (do_cocktail_in_shot shot9 cocktail4))
                (tag t10 (do_cocktail_in_shot shot10 cocktail6))
                (tag t11 (do_cocktail_in_shot shot11 cocktail2))
                (tag t12 (do_cocktail_in_shot shot12 cocktail6))
                (tag t13 (do_cocktail_in_shot shot13 cocktail4))
                (tag t14 (do_cocktail_in_shot shot14 cocktail7))
