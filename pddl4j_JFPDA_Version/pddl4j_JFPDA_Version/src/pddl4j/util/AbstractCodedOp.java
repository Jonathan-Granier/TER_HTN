...
public abstract class AbstractCodedOp implements CodedOp {
	 ...
	 */
	protected AbstractCodedOp(final AbstractCodedOp other) throws NullPointerException {
		if (other == null)
	...
	protected AbstractCodedOp(final String name, final int[] parameters, final int[] instantiations) {
		...
		if (name == null || parameters == null || instantiations == null)
			throw new NullPointerException(
					"name == null 0 || parameters == null || instantiations == null");
		this.name = name;
	 ...
	 * @throws IllegalArgumentException if <code>name < 0</code>.
	 */
	public final void setName(final String name) throws IllegalArgumentException {
		if (name == null)
	...
	/**
	 * Returns the List of parameters types of the operator or the method
	 * 
	 * @return an array of integers remresenting the types of parameters
	 */
	...
	/**
	 * Return the list of parameters values of the method
	 * 
	 * @return an int array representing the list of parameters of the method
	 */
	public final int[] getInstantiations(){
