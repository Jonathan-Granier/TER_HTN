...
final class PreInstantiation {
	...
	/**
	 * This method creates the predicatesTables used to simplify atomic expression. 
	 * 
	 * @param init the initial state.
	 */
	static void createPredicatesTables(final Set<IntExp> init) {
		if (init == null) throw new NullPointerException("The list if Int initialFacts is empty");
