...
//			}
  ...
  final public Symbol tag_symbol() throws ParseException {
        Token t;
    t = jj_consume_token(SYMBOL);
                {if (true) return new Symbol(Symbol.Kind.TASK_TAG, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public void structure_def() throws ParseException {
    ...
    } else if (jj_2_63(2) && (this.isRequirement(RequireKey.HTN))) {
      method = method_def();
                                this.domain.addMethod(method);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public Method method_def() throws ParseException {
    ...
    try {
      ...
      expansions = tag_task_list(Lexer.TERM);
      jj_consume_token(CONSTRAINTS);
      if (jj_2_64(2)) {
        constraints = and_htn_con();
      } else if (jj_2_65(2)) {
        constraints = empty_and();
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
      right_bracket();
                ...
                {if (true) return new Method(name, parameters, expansions, constraints);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp tag_task_list(int type) throws ParseException {
        Exp node = new Exp(Connective.EXPANSION);
    Exp task = null;
    left_bracket();
    label_16:
    while (true) {
  ...
  final public Exp tag_task(int type) throws ParseException {
    Exp task = null;
    Symbol tag = null;
    left_bracket();
  ...
  final public Exp task(int type) throws ParseException {
    Exp task = new Exp(Connective.TASK);
    List<Symbol> atom = new ArrayList<Symbol>();
    Symbol t = null;
    jj_consume_token(LEFT_BRACKET);
    t = task_symbol();
  ...
  final public Symbol task_symbol() throws ParseException {
    Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SYMBOL:
      t = jj_consume_token(SYMBOL);
  ...
  final public Exp pre_gd() throws ParseException {
        Exp node = null;
    if (jj_2_66(3) && (this.isRequirement(RequireKey.PREFERENCES))) {
      node = pref_gd();
    } else if (jj_2_67(2)) {
      node = and_pre_gd();
    } else if (jj_2_68(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pre_gd();
    } else if (jj_2_69(2)) {
      node = empty_or();
    } else if (jj_2_70(2)) {
  ...
  final public Exp and_htn_con() throws ParseException {
    Exp node = new Exp(Connective.AND);
    Exp c = null;
    left_bracket();
    jj_consume_token(AND);
  ...
  final public Exp and_atomic_formula() throws ParseException {
    Exp node = new Exp(Connective.AND);
    Exp c = null;
    left_bracket();
    jj_consume_token(AND);
  ...
  final public Exp htn_con() throws ParseException {
        Exp node = null;
    if (jj_2_73(2)) {
      node = series_con();
    } else if (jj_2_74(2)) {
      ...
      node = between_con();
    } else if (jj_2_77(2) && (this.isRequirement(RequireKey.EQUALITY))) {
      node = equal_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp series_con() throws ParseException {
        Exp series = new Exp(Connective.SERIES);
    Exp t = null;
    left_bracket();
    ...
    right_bracket();
                {if (true) return series;}
    throw new Error("Missing return statement in function");
  }

  final public Exp before_con() throws ParseException {
        Exp before = new Exp(Connective.BEFORE);
        Exp gd = null;
    Exp t = null;
    left_bracket();
  ...
  final public Exp after_con() throws ParseException {
    Exp after = new Exp(Connective.AFTER);
    Exp gd = null;
    Exp t = null;
    left_bracket();
  ...
  final public Exp between_con() throws ParseException {
    Exp between = new Exp(Connective.BETWEEN);
    Exp gd = null;
    Exp t = null;
    left_bracket();
  ...
  final public Exp tag_set() throws ParseException {
    Exp tagSet = new Exp(Connective.TASK_TAG_SET);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SYMBOL:
      tagSet = tag();
      break;
    ...
    default:
      ...
      throw new ParseException();
        ...
        {if (true) return tagSet;}
    throw new Error("Missing return statement in function");
  }

  final public Exp tag() throws ParseException {
    Exp tag = new Exp(Connective.TASK_TAG);
    Symbol t = null;
    t = tag_symbol();
        tag.setTag(t);
        {if (true) return tag;}
  ...
  final public Exp first_tag() throws ParseException {
    Exp first_tag = new Exp(Connective.FIRST);
    Exp t = null;
    ...
    right_bracket();
        {if (true) return first_tag;}
    throw new Error("Missing return statement in function");
  }

  final public Exp last_tag() throws ParseException {
    Exp last_tag = new Exp(Connective.LAST);
    Exp t = null;
  ...
  final public Exp empty_and() throws ParseException {
    Token t = token;
    t = jj_consume_token(LEFT_BRACKET);
    jj_consume_token(RIGHT_BRACKET);
        {if (true) return new Exp(Connective.AND);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp c_effect() throws ParseException {
        Exp node = null;
    if (jj_2_82(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_effect();
    } else if (jj_2_83(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
  ...
  final public Exp p_effect() throws ParseException {
        Exp node = null;
    if (jj_2_88(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = assign_op();
    } else if (jj_2_89(2) && (this.isRequirement(RequireKey.ACTION_COSTS))) {
  ...
  final public Exp d_op() throws ParseException {
    ...
    if (jj_2_105(2)) {
      node = equal_d_op();
    } else if (jj_2_106(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = gequal_d_op();
    } else if (jj_2_107(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = lequal_d_op();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp d_value() throws ParseException {
    ...
    if (jj_2_108(2)) {
      node = number();
    } else if (jj_2_109(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_exp();
    } else {
  ...
  final public Exp da_gd() throws ParseException {
    ...
    if (jj_2_110(2)) {
      ...
      node = and_da_gd();
    } else if (jj_2_112(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_da_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp pref_timed_gd() throws ParseException {
    ...
    if (jj_2_114(2)) {
      node = timed_gd();
    } else if (jj_2_115(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
  ...
  final public Exp da_effect() throws ParseException {
    ...
    if (jj_2_120(2)) {
      ...
      node = timed_effect();
    } else if (jj_2_122(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_da_effect();
    } else if (jj_2_123(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = when_da_effect();
  ...
  final public Exp timed_effect() throws ParseException {
    ...
    if (jj_2_141(2)) {
      node = at_a_effect();
    } else if (jj_2_142(3) && (this.isRequirement(RequireKey.CONTINOUS_EFFECTS))) {
      node = assign_op_t();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp f_exp_da() throws ParseException {
    ...
    if (jj_2_161(2)) {
      node = da_op();
    } else if (jj_2_162(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = var_duration();
    } else if (jj_2_163(2)) {
      node = f_exp();
    } else {
  ...
  final public void problem() throws ParseException {
    ...
    try {
      ...
      init();
      goal();
      if (jj_2_180(2) && (this.isRequirement(RequireKey.CONSTRAINTS))) {
  ...
  final public Exp init_el() throws ParseException {
        Exp node = null;
    if (jj_2_183(3) && (this.isRequirement(RequireKey.TIMED_INITIAL_LITERALS))) {
      node = timed_literal();
    } else if (jj_2_184(2)) {
      node = literal(Lexer.CONSTANT);
    } else if (jj_2_185(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS)
                            || this.isRequirement(RequireKey.ACTION_COSTS))) {
      node = equal_init_el();
  ...
  final public void goal() throws ParseException {
    ...
    try {
      ...
      if (jj_2_188(2) && (!this.isRequirement(RequireKey.HTN))) {
        goal = pre_gd();
        right_bracket();
      ...
      } else if (jj_2_189(2) && (this.isRequirement(RequireKey.HTN))) {
        jj_consume_token(TASKS);
        tasks = tag_task_list(Lexer.CONSTANT);
        jj_consume_token(CONSTRAINTS);
        if (jj_2_186(2)) {
          constraints = and_htn_con();
        } else if (jj_2_187(2)) {
          ...
          throw new ParseException();
                                ...
                                this.problem.setGoalTasks(tasks);
  ...
  final public Exp pref_con_gd() throws ParseException {
    ...
    } else if (jj_2_191(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pref_con_gd();
    } else if (jj_2_192(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
  ...
  final private boolean jj_3R_141() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3_142()) return true;
    }
    return false;
  }
  ...
  final private boolean jj_3R_100() {
    if (jj_3R_48()) return true;
    if (jj_scan_token(SERIES)) return true;
    return false;
  }
  ...
  final private boolean jj_3R_130() {
    ...
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    lookingAhead = false;
    if (!jj_semLA || jj_3_115()) return true;
    }
    return false;
  }
  ...
  final private boolean jj_3R_99() {
    ...
    jj_semLA = this.isRequirement(RequireKey.EQUALITY);
    lookingAhead = false;
    if (!jj_semLA || jj_3_77()) return true;
    }
    }
    }
    }
  ...
  final private boolean jj_3R_170() {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.ACTION_COSTS);
    lookingAhead = false;
    if (!jj_semLA || jj_3_185()) return true;
    }
    }
    return false;
  }
  ...
  final private boolean jj_3R_44() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_3_63()) return true;
    }
    }
    }
    return false;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x2000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0xfffffc00,0xfffffc00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x1,0x1,0x0,0xc0000000,0x0,0x0,0x0,0xc0000000,0xc0000000,0x0,0x200,0xc0000000,0xc0000000,0xc0000000,0x0,0x0,0x0,0xc0000000,0xc0000000,0xc0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x160000,0x100003,0x80000,0x160000,0x160000,0x100003,0x100003,0x100010,0x0,0x100003,0x180003,0x180003,0x200000,0x100010,0x0,0x100003,0x180003,0x100003,0x100000,0x106000,0x106000,0x106000,0x100000,0x100000,0x100000,0x200000,0x100000,0x100000,0x200008,};
   }
