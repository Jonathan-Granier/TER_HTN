...
public enum Connective {
	...
	*/
	...
	FALSE("false"),
	/**
	 * The connective for the tag-task expression.
	 */
	EXPANSION(""),
	/**
	 * The connective for the series expression.
	 */
	SERIES("series"),
	/**
	...
	BEFORE("before"),
	/**
	 * The connective for the after expression.
	 */
	AFTER("after"),
	...
	/**
	 * The connective for the task expression.
	 */
	TASK(""),
	
	/**
	 * The connective for the tag expression.
	 */
	TASK_TAG(""),
	
	/**
	 * The connective for the tagSet expression.
	 */
	TASK_TAG_SET(""),
	
	/**
	 * The connective for the first tag expression
	 */
	FIRST("first"),
	
	/**
	 * The connective for the last tag expression
	 */
	LAST("last");
