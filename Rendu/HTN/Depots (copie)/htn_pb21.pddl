...
(:goal
	:tasks  (
			 ;; A remplir 
					(tag t1 (do_put_on crate0 pallet2 ))
					(tag t2 (do_put_on crate1 pallet7 ))
					(tag t3 (do_put_on crate2 pallet11 ))
					(tag t4 (do_put_on crate3 pallet3 ))
					(tag t5 (do_put_on crate5 pallet5 ))
					(tag t6 (do_put_on crate6 pallet12 ))
					(tag t7 (do_put_on crate7 pallet18 ))
					(tag t8 (do_put_on crate8 pallet15 ))
