...
(:goal
	:tasks  (
			 ;; A remplir 
					...
					(tag t1 (do_put_on crate11 pallet1 ))

					(tag t2 (do_put_on crate17 pallet2 ))
					(tag t3 (do_put_on crate10 crate17 ))
					(tag t4 (do_put_on crate8 crate10 ))

					(tag t5 (do_put_on crate18 pallet4 ))

					(tag t6 (do_put_on crate7 pallet5 ))

					(tag t7 (do_put_on crate6 pallet6 ))

					(tag t8 (do_put_on crate15 pallet7 ))
					(tag t9 (do_put_on crate16 crate15 ))
					(tag t10 (do_put_on crate13 crate16 ))

					(tag t11 (do_put_on crate0 pallet14 ))

					(tag t12 (do_put_on crate1 pallet15 ))

					(tag t13 (do_put_on crate2 pallet13 ))

					(tag t14 (do_put_on crate3 pallet18 ))

					(tag t15 (do_put_on crate5 pallet12 ))
					
					(tag t16 (do_put_on crate9 pallet17 ))

					(tag t17 (do_put_on crate12 pallet16 ))
				
					(tag t18 (do_put_on crate19 pallet9 ))
