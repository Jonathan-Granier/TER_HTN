...
(:goal
	:tasks  (
			 ;; A remplir 
				(tag t1(do_take_image Phenomenon5 thermograph8 ))
				(tag t2(do_take_image Phenomenon5 spectrograph0 ))
				(tag t3(do_take_image Phenomenon5 image3 ))
				(tag t4(do_take_image Star6 spectrograph0 ))
				(tag t5(do_take_image Star6 spectrograph6 ))
				(tag t6(do_take_image Star6 image3 ))
				(tag t7(do_take_image Planet7 spectrograph6 ))
				(tag t8(do_take_image Planet7 infrared5 ))
				(tag t9(do_take_image Planet7 image2 ))
				(tag t10(do_take_image Phenomenon8 spectrograph6 ))
				(tag t11(do_take_image Phenomenon8 infrared5 ))
				(tag t12(do_take_image Phenomenon8 thermograph7 ))
				(tag t13(do_take_image Planet9 spectrograph6 ))
				(tag t14(do_take_image Star10 spectrograph6 ))
				(tag t15(do_take_image Star11 thermograph7 ))
				(tag t16(do_take_image Star11 image4 ))
				(tag t17(do_take_image Star11 image3 ))
				(tag t18(do_take_image Phenomenon12 image4 ))
				(tag t19(do_take_image Planet13 infrared5 ))
				(tag t20(do_take_image Planet13 spectrograph6 ))
				(tag t21(do_take_image Planet13 image2 ))
				(tag t22(do_take_image Phenomenon14 thermograph7 ))
				(tag t23(do_take_image Planet15 image3 ))
				(tag t24(do_take_image Star16 image3 ))
				(tag t25(do_take_image Star16 image4 ))
				(tag t26(do_take_image Planet18 infrared9 ))
				(tag t27(do_take_image Planet18 infrared5 ))
				(tag t28(do_take_image Planet18 thermograph7 ))
				(tag t29(do_take_image Phenomenon19 image2 ))
				(tag t30(do_take_image Phenomenon19 image4 ))
				(tag t31(do_take_image Star20 spectrograph0 ))
				(tag t32(do_take_image Phenomenon21 image4 ))
				(tag t33(do_take_image Phenomenon21 image2 ))
				(tag t34(do_take_image Phenomenon21 thermograph7 ))
				(tag t35(do_take_image Planet22 image2 ))
				(tag t36(do_take_image Planet22 spectrograph6 ))
				(tag t37(do_take_image Star23 image2 ))
				(tag t38(do_take_image Star23 infrared9 ))
				(tag t39(do_take_image Star24 spectrograph6 ))
				(tag t40(do_take_image Star24 infrared5 ))
				(tag t41(do_turn_to satellite1 Phenomenon19 ))
