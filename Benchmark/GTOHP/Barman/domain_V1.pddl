...
;------------------------------------------------------------------
    ...
    (:method do_cocktail_in_shot
        ...
        :expansion  (
                        (tag t1 (grasp ?h ?sh))
                        (tag t2 (get_first_ingredient ?sh ?c ?h))
                        (tag t3 (get_second_ingredient ?sh ?c ?h))
                        (tag t4 (serve_shot ?sh ?c ?h))
                    )
        :constraints( 
                    and 
                        (before ( and 
...
;------------------------------------------------------------------
    ...
    (:method get_first_ingredient 
        :parameters (?sh -shot ?c - cocktail ?h1 - hand)
        :expansion  (
