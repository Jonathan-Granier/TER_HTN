...
PDDL="PDDL"
CORE="CORE"
FILE_TIME_STAT="Stats/Data/Stat_Temps_de_resolution_$1.dat"
FILE_SIZE_PLAN_STAT="Stats/Data/Stat_Taille_plan_$1.dat"
###################
...
function test_un_probleme()
{
	...
	timeout $TIMEMAX ./$SCRIPT_PDDL -g $1 $2 > $TEMP
	RETVAL=$?
...
if [ $MAKE_PDDL -eq 1 ]; then
	echo "No_Prob ; $GTOHP ; $CORE ; $PDDL " > $FILE_TIME_STAT
	echo "No_Prob ; $GTOHP ; $CORE ; $PDDL" > $FILE_SIZE_PLAN_STAT
else
	echo "No_Prob ; $GTOHP ; $CORE " > $FILE_TIME_STAT
	echo "No_Prob ; $GTOHP ; $CORE " > $FILE_SIZE_PLAN_STAT
fi
